...
public class Detectare_Culori_Contururi_Determinareapoligoanelor extends LinearOpMode {
    ...
    class SamplePipeline extends OpenCvPipeline{//clasa pentru procesarea imaginii
        ...
        public Mat processFrame(Mat input)  {
            ...
            int bluePixel = Core.countNonZero(maskBlue);//determina numarul de pixeli de culoare
            ...
            }//determina care este culoarea predominata

            telemetry.addData("Culoarte predominanta", predominatntColor);
            telemetry.update();//afiseaza pe drive hub culoare predominata
